...
<div id="wrapper">
    ...
    <div class="content">
        ...
        <section class="scroll-con-sec hero-section" data-scrollax-parent="true" id="sec1">
            <div class="bg"  data-bg="{{ asset('assets/images/bg/32.jpg') }}" data-scrollax="properties: { translateY: '200px' }"></div>
            ...
            <div class="container">
                ...
                <div class="gallery-items fl-wrap mr-bot spad">
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="bg"  data-bg="{{ asset('assets/images/all/22.jpg') }}"></div>
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="bg"  data-bg="{{ asset('assets/images/all/5.jpg') }}"></div>
                ...
                <div class="listing-carousel  fl-wrap ">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/5.jpg') }}" alt=""></a>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    <img src=" {{ asset('assets/images/all/2.jpg') }}" alt="">
                                    <div class="overlay"></div>
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/2.jpg') }}" alt=""></a>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    <img src=" {{ asset('assets/images/all/20.jpg') }}" alt="">
                                    <div class="overlay"></div>
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/4.jpg') }}" alt=""></a>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    <img src=" {{ asset('assets/images/all/5.jpg') }}" alt="">
                                    <div class="overlay"></div>
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/1.jpg') }}" alt=""></a>
                                        <span class="avatar-tooltip">Added By  <strong>Nasty Wood</strong></span>
                                    </div>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    <img src=" {{ asset('assets/images/all/6.jpg') }}" alt="">
                                    <div class="overlay"></div>
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/6.jpg') }}" alt=""></a>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    <img src=" {{ asset('assets/images/all/4.jpg') }}" alt="">
                                    <div class="overlay"></div>
                                ...
                                <div class="geodir-category-content fl-wrap">
                                    ...
                                    <div class="listing-avatar"><a href="author-single.html"><img src=" {{ asset('assets/images/avatar/3.jpg') }}" alt=""></a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images-collage fl-wrap">
                            ...
                            <div class="images-collage-main images-collage-item"><img src=" {{ asset('assets/images/avatar/1.jpg') }}" alt=""></div>
                            <div class="images-collage-other images-collage-item" data-position-left="23" data-position-top="10" data-zindex="2"><img src=" {{ asset('assets/images/avatar/2.jpg') }}" alt=""></div>
                            <div class="images-collage-other images-collage-item" data-position-left="62" data-position-top="54" data-zindex="5"><img src=" {{ asset('assets/images/avatar/4.jpg') }}" alt=""></div>
                            <div class="images-collage-other images-collage-item anim-col" data-position-left="18" data-position-top="70" data-zindex="11"><img src=" {{ asset('assets/images/avatar/6.jpg') }}" alt=""></div>
                            <div class="images-collage-other images-collage-item" data-position-left="37" data-position-top="90" data-zindex="1"><img src=" {{ asset('assets/images/avatar/5.jpg') }}" alt=""></div>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="parallax-section" data-scrollax-parent="true">
            <div class="bg"  data-bg="{{ asset('assets/images/bg/8.jpg') }}" data-scrollax="properties: { translateY: '100px' }"></div>
                ...
                <div class="testimonials-carousel single-carousel fl-wrap">
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="testimonilas-avatar-item">
                            <div class="testimonilas-avatar"><img src=" {{ asset('assets/images/avatar/4.jpg') }}" alt=""></div>
                            <h4>Lisa Noory</h4>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="testimonilas-avatar-item">
                            <div class="testimonilas-avatar"><img src=" {{ asset('assets/images/avatar/3.jpg') }}" alt=""></div>
                            <h4>Antony Moore</h4>
                            <span>Restaurant Owner</span>
                        </div>
                    </div>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="testimonilas-avatar-item">
                            <div class="testimonilas-avatar"><img src=" {{ asset('assets/images/avatar/1.jpg') }}" alt=""></div>
                    ...
                    <div class="slick-slide-item">
                        ...
                        <div class="testimonilas-avatar-item">
                            <div class="testimonilas-avatar"><img src=" {{ asset('assets/images/avatar/6.jpg') }}" alt=""></div>
                            <h4>Garry Colonsi</h4>
                            <span>Restaurant Owner</span>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="fl-wrap spons-list">
                    <ul class="client-carousel">
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/1.png') }}" alt=""></a></li>
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/2.png') }}" alt=""></a></li>
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/3.png') }}" alt=""></a></li>
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/1.png') }}" alt=""></a></li>
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/2.png') }}" alt=""></a></li>
                        <li><a href="#" target="_blank"><img src=" {{ asset('assets/images/clients/3.png') }}" alt=""></a></li>
                    </ul>
                    ...
                    <div class="col-md-4">
                        <article class="card-post">
                            <div class="card-post-img fl-wrap">
                                <a href="blog-single.html"><img src=" {{ asset('assets/images/all/15.jpg') }}"   alt=""></a>
                            </div>
                            <div class="card-post-content fl-wrap">
                                <h3><a href="blog-single.html">Gallery Post</a></h3>
                                <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                <div class="post-author"><a href="#"><img src=" {{ asset('assets/images/avatar/4.jpg') }}" alt=""><span>By , Alisa Noory</span></a></div>
                                <div class="post-opt">
                                    <ul>
                    ...
                    <div class="col-md-4">
                        <article class="card-post">
                            ...
                            <div class="card-post-content fl-wrap">
                                ...
                                <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                <div class="post-author"><a href="#"><img src=" {{ asset('assets/images/avatar/5.jpg') }}" alt=""><span>By , Mery Lynn</span></a></div>
                                <div class="post-opt">
                                    <ul>
                                        <li><i class="fa fa-calendar-check-o"></i> <span>25 April 2018</span></li>
                                        <li><i class="fa fa-eye"></i> <span>264</span></li>
                    ...
                    <div class="col-md-4">
                        <article class="card-post">
                            ...
                            <div class="card-post-content fl-wrap">
                                ...
                                <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                <div class="post-author"><a href="#"><img src=" {{ asset('assets/images/avatar/6.jpg') }}" alt=""><span>By , Garry Dee</span></a></div>
                                <div class="post-opt">
                                    <ul>
                                        <li><i class="fa fa-calendar-check-o"></i> <span>25 April 2018</span></li>
                                        <li><i class="fa fa-eye"></i> <span>264</span></li>
        ...
        <section class="gradient-bg">
            <div class="cirle-bg">
                <div class="bg" data-bg="{{ asset('assets/images/bg/circle.png') }}"></div>
            </div>
            <div class="container">
