<?php $__env->startSection('title', 'ویرایش شهر'); ?>
                        ...
                        <form method="post" action=" <?php echo e(route('city.update', $city->id)); ?> ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="<?php echo e($city->name); ?>" placeholder="لطفا نام شهر را وارد کنید">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">ویرایش شهر</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
<?php echo $__env->make('layout.base_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Faradars\ads\resources\views/admin/city/edit.blade.php ENDPATH**/ ?>