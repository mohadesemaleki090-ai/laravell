            ...
            <div class="col-md-3">
                <div class="footer-widget fl-wrap">
                    ...
                    <div class="widget-posts fl-wrap">
                        <ul>
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src=" {{ asset('assets/images/all/1.jpg') }}" class="respimg" alt=""></a>
                            ...
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src=" {{ asset('assets/images/all/2.jpg') }}" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
                            ...
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src=" {{ asset('assets/images/all/3.jpg') }}" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
